...
--imgformat=PNG \
--start=$stime \
--title="Inventory and US Sales (last $ts months)" \
--rigid \
--base=1000 \
--height=240 \
--width=500 \
...
DEF:Total_Inventory=/var/www/data/Gap/Total_Inventory.rrd:Total_Inventory:AVERAGE \
AREA:Total_Inventory#00DD66:"Total Inventory" \
LINE4:US_Sales#003366:"US Sales" 
