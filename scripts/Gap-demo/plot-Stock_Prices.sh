...
--imgformat=PNG \
--start=$stime \
--title="Stock Prices (last $ts months)" \
--rigid \
--base=1000 \
--height=240 \
--width=500 \
...
--color CANVAS#FFFFFF \
--color BACK#AAAAAA \
DEF:Stock_Prices=/var/www/data/Gap/Stock_Prices.rrd:Stock_Prices:LAST \
...
LINE4:Stock_Prices#3300FF:"Stock Prices" \
