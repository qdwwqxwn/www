...
--imgformat=PNG \
--start=$stime \
--title="Regional Sales (last $ts months)" \
--rigid \
--base=1000 \
--height=240 \
--width=500 \
...
AREA:US_Sales#0099FF:"US Sales" \
STACK:China_Sales#FF6600:"China Sales" \
STACK:EU_Sales#00CCFF:"EU Sales" 
